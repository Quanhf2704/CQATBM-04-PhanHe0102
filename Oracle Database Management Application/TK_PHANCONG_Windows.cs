...
{
    public partial class TK_PHANCONG_Windows : Form
    {
        private List<List<string>> phanconglist;
        public TK_PHANCONG_Windows()
        {
            InitializeComponent();
        }
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "INSERT INTO USERDBA.PHANCONG VALUES (\'" + MAGVtextBox.Text + "\', \'" + MAHPtextBox.Text
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            ...
            OracleCommand cmd = new OracleCommand();
            cmd.Connection = conn;
            cmd.CommandText = "DELETE FROM USERDBA.PHANCONG WHERE MAGV = \'" + MAGVtextBox.Text + "\' AND MAHP =  \'" + MAHPtextBox.Text
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd.CommandText = "UPDATE USERDBA.PHANCONG SET MAGV = \'" + newmagvtextBox.Text;
                newmacttextBox.Visible = false;
            } else if (newmahptextBox.Visible == true)
            {
                cmd.CommandText = "UPDATE USERDBA.PHANCONG SET MAHP= \'" + newmahptextBox.Text;
                newmahptextBox.Visible = false;
            } else if (newhktextBox.Visible == true)
            {
                cmd.CommandText = "UPDATE USERDBA.PHANCONG SET HK = \'" + newhktextBox.Text;
                newhktextBox.Visible = false;
            } else if (newnamtextBox.Visible == true)
            {
                cmd.CommandText = "UPDATE USERDBA.PHANCONG SET NAM = \'" + newnamtextBox.Text;
                newnamtextBox.Visible = false;
            } else if (newmacttextBox.Visible == true)
            {
                cmd.CommandText = "UPDATE USERDBA.PHANCONG SET MACT = \'" + newmacttextBox.Text;
                newmacttextBox.Visible = false;
            }
